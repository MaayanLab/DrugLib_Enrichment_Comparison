...
def list_of_drug_libs_fnames():
	...
	expanded_drug_libs = ('1_DrugBank_Column_5OrMoreTargets_MissingChEMBL_IDsRemoved_1-14-18',
...
if __name__ == '__main__':
	...
	Parallel(n_jobs=6, verbose=0)(delayed(enrichment)(pair) for pair in lib_df_pairs)