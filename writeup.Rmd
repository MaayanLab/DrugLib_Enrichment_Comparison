...
colnames(t1) = c('Name', 'Library Type', 'Description','Number of samples', 'Number of unique drugs', 'Number of genes', 'Average number of genes per annotation', 'Data preprocessing')
...
![](figures/druglib_bridgeplot.png)